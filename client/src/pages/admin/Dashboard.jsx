...
import { CurveButton, SearchField } from '../../components/styles/StylesComponents'
...
const Dashboard = () => {
  ...
  const Widgets = <Stack direction={{ xs: "column", sm: "row" }} spacing={"2rem"} justifyContent={"space-between"} alignItems={"center"} margin={"2rem 0"} >
    ...
    <Widget title={"user"} value={34} icon={<MessageIcon />} />
  </Stack>
  return (
    <AdminLayout>
...
const Widget = ({ title, value, icon }) => <Paper sx={{ padding: "2rem", borderRadius: "1rem", width: "20rem", margin: "2rem 0" }}  >
